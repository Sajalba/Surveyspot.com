...
<table width="100%" height="30%" >
  <tr>
    ...
    <table width="1113">
      <tr>
        <td height="189" colspan="6"><marquee behavior="alternate" direction="right"><u>Delete Officer</u></marquee></td>
        </tr>
      </table>
...
?>
 <center>
    ...
    <table width="76%" border="0" style="margin-left:250px; margin-top:-20px;">
	<tr class="th1">
    <th width="14%">Id</th>
    <th width="20%">Name</th>
...
?> <?php
	   $officerid=$_POST['officerid'];
        ...
        <p style="margin-top:5px;">
         <a href="admindelete1.php?off_id=<?php echo $result1[off_id];?>&off_name=<?php echo $result1[off_name];?>&off_address=<?php echo $result1[off_address];?>&off_mobno=<?php echo $result1[off_mobno];?>&off_pass=<?php echo $result1[off_pass];?>" class="d1"><font color="black">DELETE</font></a></p><br />
        <?php
	  	}
	else
	{
