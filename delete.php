...
<table width="100%" height="30%" >
  <tr>
    ...
    <table width="1113">
      <tr>
        <td height="189" colspan="6"><marquee behavior="alternate" direction="right"><u>Delete Data</u></marquee></td>
        </tr>
      </table>
...
<table width=64% border="0">
  <tr>
    <td width="35%" class= "drop">Rank</td>
    <td><input name="rank" type="text"  class = "lb"  placeholder="Enter Here" maxlength="3" /></td>
  </tr>
  <tr>
...
?>
 ...
 <?php
	   ...
	   <?php
		...
		?>
	   <a onclick='return checkdelete()' href="delete1.php?rank=<?php echo $result1[rank];?>&type=<?php echo $result1[type];?>&name=<?php echo $result1[name];?>&address=<?php echo $result1[address];?>&district=<?php echo $result1[district];?>&engg_intake=<?php echo $result1[engg_intake];?>&hon_intake=<?php echo $result1[hon_intake];?>&courses=<?php echo $result1[courses];?>&univ=<?php echo $result1[univ];?>&web=<?php echo $result1[web];?>" class="d1"><font color="black">Delete</font></a>
	   <?php
