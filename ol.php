...
<table width="100%" height="30%" >
  <tr>
    ...
    <table width="1113">
      <tr>
        <td height="189" colspan="6"><marquee behavior="alternate" direction="right"><u>Officer Login</u></marquee></td>
        </tr>
        </table>
      ...
      <tr>
        ...
        <th width="379"> <a href="logout.php">Logout</a><img src="icons8-shutdown-48.png" width="18" height="18" /></a></th>
        </tr>
    </table>  
  </tr>
  </table>
