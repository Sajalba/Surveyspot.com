...
<center>
  <div class="content">
<h1 class="header" align="center"> Officer Login </h1>
<div class="z">
<div class="y">
<br>
<br>
...
Officer Id: <input name="user" type="text" value="" maxlength="10" style="height:20px;"/><br><br><br>
...
if(isset($_POST['submit']))
{
	$user = $_POST['user'];
	$pwd = $_POST['pass'];
	$query = "SELECT * FROM addofficer WHERE off_id='$user' && off_pass='$pwd'";
