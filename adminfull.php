...
<table width="100%" height="30%" >
  <tr>
    ...
    <table width="1113">
      <tr>
        <td height="189" colspan="6"><marquee behavior="alternate" direction="right"><u>Data</u></marquee></td>
        </tr>
      </table>
...
?>
 <center>
    ...
    <table width="79%" border="0" style="margin-left:250px; margin-top:-400px">
   <tr class="th1">
    <th width="5%">Rank</th>
    <th width="8%">Type</th>
    <th width="8%">Name</th>
...
<?php 
		if($total!=0)
{ ?>   	<button onclick="myFunction()" style="height:40px; width:100px;">Print</button><br /><br />
<?php
}
?>
	</center>
